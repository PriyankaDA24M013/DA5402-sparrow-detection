...
def faster_rcnn_mob_model_for_n_classes(num_classes, print_head=False, trainable_backbone_layers=3):
    ...
    # For older torchvision versions, use pretrained=True instead of weights='COCO_V1'
    faster_rcnn_mob = fasterrcnn_mobilenet_v3_large_fpn(
        pretrained=True,
